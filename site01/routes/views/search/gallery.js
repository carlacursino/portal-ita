...
module.exports = (req, res) => {
    ...
    res.locals.filters = { gallery: req.params.gallery }
    ...
    view.on('init', (next) => {
        partials.category({ slug: [res.locals.filters.gallery] }, res.locals.language, (err, result) => {
