...
Post.add({
    ...
    panel: { type: Types.Select, options: 'acontece, destaque, link, slider, info, grad, posgrad, pg, g, area, visao, valores, coop, noticia', default: 'noticia', index: true, many: true },
...
Post.defaultColumns = 'id, slug, title, subtitle, state, publishedDate, categories, downloads, panel'
